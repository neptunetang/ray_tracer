...
void create_scene(vec3 &look_from, vec3& look_at, hitable* &world, light &light_area, int scene){
    ...
    int m_x, m_y, m_n;
    unsigned char* m_data = stbi_load("fur.jpg", &m_x, &m_y, &m_n, 0);
...
//            list[2] = new xy_rect(5,10,5,10,2, new diffuse_light((new constant_texture(vec3(5,5,5)))));
        ...
        case 8:
            ...
            //E
            box2 = new box(vec3(0,0,0), vec3(50,50,50), new diffuse(moon_surface));
        ...
        case 9:
            ...
            list[i++] = new flip_face(new xy_rect(0,60,0,555,554,new diffuse_light(new constant_texture(vec3(5,5,5)))));
            light_area = light(new flip_face(new xy_rect(0,60,0,555,554,new diffuse_light(new constant_texture(vec3(5,5,5))))), vec3(5,5,5), 5);
            look_from = vec3(278, 278, -800);
            look_at = vec3(278,278,0);
